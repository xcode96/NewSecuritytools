...
export const NistIcon: React.FC<IconProps> = (props) => (
  <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
    <path d="M4.5 4.5h15v15h-15V4.5zm1.5 1.5v12h12V6H6zm2.25 3h1.5v6h-1.5V9zm3 0h1.5v6h-1.5V9zm3 0h1.5v6h-1.5V9z" />
    <path d="M2 2h20v20H2V2zm18 18V4H4v16h16z" fill="none" stroke="currentColor" strokeWidth="1.5" />
  </svg>
);

export const MicrosoftIcon: React.FC<IconProps> = (props) => (
  <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
    <path d="M2 2h9v9H2V2zm11 0h9v9h-9V2zM2 13h9v9H2v-9zm11 0h9v9h-9v-9z" fill="#f25022" />
...
export const AppleIcon: React.FC<IconProps> = (props) => (
  <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
    <path d="M18.71 19.5c-.322.956-1.042 2.508-2.128 2.476-1.348-.035-1.57-.803-3.219-.803-1.63 0-2.115.787-3.243.82-1.228.026-2.152-1.246-3.704-3.64-2.522-3.892-1.233-8.158 1.151-9.284 1.344-.616 2.525-.32 3.44-.066.862.248 1.968-.696 3.635-.696 1.196 0 2.656.402 3.623 1.077-3.088 1.867-2.31 5.955.516 7.116zm-5.69-15.688c.636-.889 1.125-1.996.953-3.099-1.05.088-2.365.86-3.003 1.716-.549.721-.99 1.942-.773 2.973 1.173.12 2.29-.699 2.823-1.59z" />
  </svg>
);

export const AdobeIcon: React.FC<IconProps> = (props) => (
  <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
    <path d="M15.1 2H24v20L15.1 2zM8.9 2H0v20L8.9 2zM12 9.4L17.6 22h-2.9l-1.5-4h-3.5l-1 2.6L12 9.4z" fill="#FF0000" />
  </svg>
);

export const OracleIcon: React.FC<IconProps> = (props) => (
  <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
    <path d="M16.41 6.88h-8.83C4.24 6.88 2 9.21 2 12s2.24 5.12 5.58 5.12h8.83c3.34 0 5.59-2.33 5.59-5.12s-2.25-5.12-5.59-5.12zm0 8.44h-8.83c-2.3 0-3.32-1.76-3.32-3.32s1.02-3.32 3.32-3.32h8.83c2.3 0 3.33 1.76 3.33 3.32s-1.03 3.32-3.33 3.32z" fill="#f80000" />
  </svg>
);

export const MozillaIcon: React.FC<IconProps> = (props) => (
  <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
    <path d="M21.215 11.234c.05.474.135.932.164 1.4.218 3.525-.873 6.002-3.033 7.64-1.895 1.442-4.634 1.487-6.075.093l-.338-.328c-.29-.282.895 1.5.895 1.5 1.782 1.975 5.558 1.156 7.647-.946 2.062-2.074 3.012-5.786 1.341-10.03-.131-.334-.582-.375-.601.671zm-9.52 7.026c.725.26 1.477.37 2.215.352 2.768-.066 3.65-3.007 3.633-5.26-.007-1.094-.176-2.126-.412-2.936-.452-1.554-1.393-2.673-2.613-2.977-.872-.217-1.597.042-2.067.728-.865 1.258-2.658 2.072-2.658 2.072.1.282.535 1.472.585 1.57.733 1.465 1.256 2.043 1.26 3.193.002.588-.363.856-.763.585-.487-.33-.314-1.868-1.523-4.545-2.482 1.354-2.274 5.378-2.274 5.378-.04 1.996 1.135 3.064 2.892 2.915.688-.058 1.137-.473 1.636-.59.083-.02 1.372 2.375 1.372 2.375a3.91 3.91 0 0 0-1.283-2.86z" />
  </svg>
);

export const DebianIcon: React.FC<IconProps> = (props) => (
  <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
    <path d="M10.875 3.842c-2.88 1.056-4.996 4.314-5.228 8.046-.021.319-.074.453-.285.696-.349.39-.77.538-1.414.506C2.887 13.036 1.47 11.232 3.1 8c1.37-2.738 4.602-4.93 7.828-5.32 6.551-.78 11.397 3.161 11.777 9.585.19 2.87-1.097 5.672-3.52 7.665-2.064 1.7-4.435 2.101-7.067 1.14-.99-.358-1.412-.875-1.433-1.686-.021-.928.621-1.603 1.697-1.782.56-.095.949-.032 1.644.253.949.39 1.497.358 2.361-.137 1.16-.675 2.11-2.013 2.51-3.606.327-1.286.295-3.32-.084-3.669-.601-.548-2.424-.59-5.186-.105-2.908.516-4.826 1.96-5.87 4.437-.306.749-.306 1.571.021 1.023.21.369 1.17 1.129 1.761 1.403.717.338 2.066.422 2.762.18.506-.18.664-.17 1.149.095.537.284.601.506.495 1.518-.084.77-.527 1.56-1.075 1.908-.95.611-3.132.558-4.334-.116-2.58-1.444-4.22-3.826-4.495-6.524-.263-2.613.685-5.363 2.666-7.799 2.128-2.612 5.217-3.887 9.2-3.803 5.48.116 10.43 4.198 10.967 9.079.169 1.465.042 3.51-.253 4.174l-.232.527-.453-.517C20.697 13.69 20.37 8.356 16.29 5.86c-1.633-.99-3.793-1.623-5.395-1.58-.948.021.053-.453-.021-.438z" fill="#D70A53" />
  </svg>
);

export const RedHatIcon: React.FC<IconProps> = (props) => (
  <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
    <path d="M12 2c5.523 0 10 4.477 10 10s-4.477 10-10 10S2 17.523 2 12 6.477 2 12 2zm0 2a8 8 0 1 0 0 16 8 8 0 0 0 0-16z" fill="#EE0000" />
    <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 14c-2.21 0-4-1.79-4-4s1.79-4 4-4 4 1.79 4 4-1.79 4-4 4z" fill="none" />
  </svg>
);

export const SuseIcon: React.FC<IconProps> = (props) => (
  <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
    <path d="M11.95 2.05c-5.5 0-9.95 4.5-9.95 10 0 5.4 4.5 9.85 10 9.85 5.25 0 9.5-4.25 9.75-9.45v-.4C21.75 6.6 17.35 2.2 11.95 2.05zm5.75 7.15c-.2.55-.25 1.1-.15 1.65.2.95.85 1.65 1.8 1.8.8.15 1.55-.25 1.95-.95.4-.7.3-1.55-.25-2.25-.5-.7-1.35-1.05-2.15-.9-.65.1-1.05.35-1.2.65zm-11.45 6.3c.3.5.9.8.9 1.4 0 .9-.75 2-1.9 2-1.15 0-2-1.1-2-1.9 0-1.15 1.1-2.05 2-2.05.5 0 .9.25 1 .55zm5.8 4.2c-1.15 0-2.35-.45-3.35-1.25-.85-.7-1.25-1.65-1.25-2.7 0-1.4 1.05-2.6 2.6-3.05.95-.3 2.05-.1 3 .55.65.45.95 1.1.85 1.9-.1 1.25-1.15 2.25-2.45 2.3-.4 0-.8-.1-1.1-.3-.65-.45-.65-1.3-.05-1.8.45-.4 1.25-.3 1.55.25.1.15.15.35.1.55-.05.55-.55.95-1.15.95-.35 0-.7-.15-.9-.45-.35-.55-.15-1.3.4-1.7.55-.4 1.35-.35 1.8.15.45.5.45 1.15 0 1.6-.2.25-.55.45-.9.5-.85.1-1.65-.45-1.75-1.25-.1-.85.5-1.65 1.3-1.75.95-.1 1.65.65 1.8 1.55.15 1.15-.65 2.25-1.75 2.4-1.45.25-2.85-.75-3.15-2.15-.3-1.45.65-2.85 2.1-3.2 1.45-.3 2.85.65 3.2 2.05.15.65.05 1.25-.25 1.75" fill="#30BA78" />
  </svg>
);

export const CisaIcon: React.FC<IconProps> = (props) => (
  <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
    <path d="M12 2L2 22h20L12 2zm0 3.8l6.1 12.2H5.9L12 5.8z" fill="#005288" />
    <path d="M12 16a2 2 0 1 0 0-4 2 2 0 0 0 0 4z" fill="#005288" />
  </svg>
);

export const Rapid7Icon: React.FC<IconProps> = (props) => (
  <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
    <path d="M3.5 12a8.5 8.5 0 1 1 17 0 8.5 8.5 0 0 1-17 0z" fill="#EA5E26" />
    <path d="M10.5 7h5.5l-3 9.5H10L12 11H9l1.5-4z" fill="#fff" />
  </svg>
);

export const TenableIcon: React.FC<IconProps> = (props) => (
  <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
    <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1 14.5v-9l6 4.5-6 4.5z" fill="#00356C" />
  </svg>
);

export const QualysIcon: React.FC<IconProps> = (props) => (
  <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
    <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zm-1-13h2v6h-2zm0 8h2v2h-2z" fill="#2E8BC9" />
  </svg>
);

export const MitreIcon: React.FC<IconProps> = (props) => (
  <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
    <path d="M2.5 12l3-5 3 5-3 5-3-5zm6.5-6l3-5 3 5-3 5-3-5zm6.5 6l3-5 3 5-3 5-3-5z" fill="#005B94" />
  </svg>
);
